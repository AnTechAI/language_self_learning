...
| Ví dụ câu | `examples` | string[] | ⬜ | *(đề xuất bổ sung — xem mục 6)* |
| Chủ đề/tag | `tags` | string[] | ⬜ | *(đề xuất bổ sung)* |
...
- *(Tùy chọn)* Import hàng loạt từ file CSV/Excel hoặc qua API từ điển (vd. Free Dictionary API) để tự động điền phiên âm/nghĩa.
...
- *(Tùy chọn)* Spaced repetition: ưu tiên ôn lại từ hay sai hoặc lâu chưa ôn.
